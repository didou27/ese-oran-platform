...
- Semester 1 and Semester 3 master timetable imported from the provided workbook.
...
The imported schedule was extracted from `emploi-du-temps_tous-les-filtres (4) (1).xlsx`. The original files are included in `source_data` for reference.
